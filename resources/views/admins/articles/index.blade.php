    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="center">
                    <a class="btn btn-small btn-primary showActivatedGarage" href="{{ route('articles.show', $item->id) }}">
                        <span class="glyphicon glyphicon-eye-open"></span>
                    </a>
                </td>
                @if ($status == config('common.article.status.activated'))
                <td class="center">
                    {!!  Form::open(['method' => 'PUT', 'route' => ['articles.update', $item->id]]) !!}
                ...
                <td class="center">
                    {!! Form::open(['method' => 'DELETE', 'route' => ['articles.destroy', $item->id]]) !!}
